        ...
        <div className="home-container">
            ...
            <header className="header">
                <div className="header-content">
                    ...
                    <h3>Dive into our collection of bestsellers <br/>
                        and compelling reads</h3>
                    <button
                        className="gomb1"
                ...
                <div className="header-images">
                    <img src="../public/headerImgAlso.svg" alt=""  className="headerAlso"/>
                    <img src="../public/headerImgFelso.svg" alt="" className="headerFelso"/>
                </div>
            </header>
