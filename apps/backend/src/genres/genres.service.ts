...
export class GenresService {
   ...
   * @throws InternalServerErrorException If there was an error processing the genres in bulk.
   */
   ...
   * @throws InternalServerErrorException If there was an error while searching for genres.
   */
   ...
   * @throws InternalServerErrorException If there was an error while creating the genre.
   */
   ...
   * @throws InternalServerErrorException If there was an error while retrieving the genres.
   */
   ...
   * @returns A list of genres matching the criteria.
   * @throws InternalServerErrorException If there was an error while retrieving the genre.
   */
   ...
   * @throws NotFoundException If no genre exists with the specified ID.
   */
   ...
   * @throws InternalServerErrorException If there was an error while retrieving the top genres and their popular books.
   */
   ...
   * @throws NotFoundException If no genre exists with the specified ID.
   * @throws ConflictException If the genre is linked to existing books.
   * @throws InternalServerErrorException If there was an error while deleting the genre.
   */
